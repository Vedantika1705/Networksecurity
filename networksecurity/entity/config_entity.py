...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TraningPipelineConfig):
        ...
        self.train_test_split_ratio: float = (
            traning_pipeline.DATA_INGESTION_TRAIN_TEST_SPLIT_RATION
        )
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TraningPipelineConfig):
        ...
        self.valid_test_file_path: str = os.path.join(self.valid_data_dir, traning_pipeline.TEST_FILE_NAME)
        ...
        self.drift_report_file_path: str = os.path.join(
            ...
            traning_pipeline.DATA_VALIDATION_DRIFT_FILE_NAME,
        )
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TraningPipelineConfig):
        self.model_trainer_dir: str = os.path.join(
            training_pipeline_config.artifact_dir, traning_pipeline.MODEL_TRAINER_DIR_NAME
        )
        self.trained_model_file_path: str = os.path.join(
            self.model_trainer_dir, traning_pipeline.MODEL_TRAINER_TRAINED_MODEL_DIR, 
            traning_pipeline.MODEL_FILE_NAME
        )
        self.expected_accuracy: float = traning_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_threshold = traning_pipeline.MODEL_TRAINER_OVER_FIITING_UNDER_FITTING_THRESHOLD